          ...
          <form onSubmit={handleSubmit(onSubmit)} className="max-w-sm mx-auto">
              ...
              <div className="flex gap-[10px] my-4">
                <div>
                  ...
                  <input
                    ...
                    {...register("firstname")}
                  />
                  {errors && <p className="text-red-600 text-sm">{errors.firstname?.message}</p>}
                </div>
                <div>
                  ...
                  <input
                    ...
                    {...register("lastname")}
                  />
                  {errors && <p className="text-red-600 text-sm">{errors.lastname?.message}</p>}
                </div>
              </div>
            ...
            <div className="mb-5">
              ...
              <input
                ...
                {...register("password")}
              />
              {errors && <p className="text-red-600 text-sm">{errors.password?.message}</p>}
            </div>
