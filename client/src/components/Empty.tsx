...
const Empty = () => {
  return (
    <section className="grid justify-items-center items-center mx-auto gap-[20px]">
      <div className="flex mt-[140px] gap-5 justify-center items-center">
      ...
      <p className="text-trunks max-w-sm text-center text-sm-r">
        Punya tugas serabutan yang butuh bantuan? Atau ada pekerjaan yang bisa
        dikerjain orang lain? Bikin lowonganmu sendiri di sini! Siapa tahu ada
        yang butuh tambahan duit dan siap bantuin kamu.
      </p>
      <Link
        to={"/create-vacancy"}
        type="button"
