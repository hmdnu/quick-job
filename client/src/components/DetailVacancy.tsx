    ...
    <section className="sticky top-[120px] md:basis-3/5 lg:basis-2/5 p-[20px] hidden h-full md:grid border border-gray-200 rounded-lg shadow">
      <div className="grid justify-items-start">
        <div className="flex flexCenter gap-[10px]">
          <img src="/img/user.jpg" alt="user" className="w-[40px] h-[40px] lg:w-[50px] lg:h-[50px] rounded-full" />
          <div className="flex md:grid gap-1 items-center justify-start">
            <h1 className="text-bulma text-sm-s">Lavina Kim</h1>
            <div className="md:hidden bg-bulma h-1 w-1 rounded-full"></div>
            <h6 className="text-trunks text-xs-r">1 menit lalu</h6>
          </div>
        </div>
        <div className="hidden mt-[20px] lg:inline-block rounded-lg bg-chici-90 bg-opacity-30 px-[6px] pt-[6px]">
          <h5 className="mb-2 text-sm-s text-chici-90">Kadaluarsa dalam 30 menit</h5>
        </div>
      </div>
      <div className="grid mt-[10px] gap-[10px] md:gap-0">
        <h1 className="text-sm-s md:text-md-s text-bulma">Tolong dong yg bisa jastip jajan</h1>
        <div className="grid my-2 gap-1">
          <div className="flex items-center gap-[5px]">
            ...
            <span className="text-xs-r md:text-xs-r text-trunks">Lowokwaru, Malang</span>
          </div>
          <div className="flex items-center gap-[5px]">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <h1 className="text-xs-r">Rp 50.000</h1>
          </div>
        </div>
        <p className="text-xs-r md:text-sm-r text-trunks">
          Titip belikan makaroni ngehe hehehe, kirim ke gedung AX Polinema ya !
          <br />
          Rincian: Level 1 nya 2 Level 2 nya 1 Level 3 nya gak level :P Kalau
          <br />
          kurang jelas bisa tanya duluu yaa lewat chatt Mwakasiii
        </p>
      </div>
